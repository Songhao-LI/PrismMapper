...
using TriangleNet;
using UnityEngine;
public class AddPrismMapDemo : MonoBehaviour
{
    void Start()
    {
        ...
        guids = MapDrawer.CreateBaseMap(postions, .1f, UnityEngine.Color.black, UnityEngine.Color.blue, false, .2f);
        MapDrawer.AddPrismMap(guids[39], 20, UnityEngine.Color.black);
        MapDrawer.AddPrismMap(guids[40], 20, UnityEngine.Color.black);
        MapDrawer.AddPrismMap(guids[47], 10, UnityEngine.Color.black);
        MapDrawer.AddPrismMap(guids[48], 10, UnityEngine.Color.black);
        MapDrawer.AddPrismMap(guids[59], 10, UnityEngine.Color.black);
        MapDrawer.AddPrismMap(guids[60], 10, UnityEngine.Color.black);
        MapDrawer.AddPrismMap(guids[70], 10, UnityEngine.Color.black);
        MapDrawer.AddPrismMap(guids[71], 30, UnityEngine.Color.black);
        MapDrawer.AddPrismMap(guids[73], 20, UnityEngine.Color.black);
        MapDrawer.AddPrismMap(guids[88], 20, UnityEngine.Color.black);
        MapDrawer.AddPrismMap(guids[90], 20, UnityEngine.Color.black);
